 ...
 * ─────────────────────────────────────────────────────
 */
const NGROK_URL = 'https://1b1b-105-174-52-229.ngrok-free.app'; // ← Cola aqui a URL do ngrok quando disponível
...
const api = axios.create({
  ...
  headers: {
    ...
    'ngrok-skip-browser-warning': 'true', // Ignora a página de aviso do ngrok no browser
  },
});
